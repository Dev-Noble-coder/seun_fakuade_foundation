          ...
          >
            <div className="relative overflow-hidden rounded-2xl shadow-2xl bg-gradient-to-br from-gray-100 to-gray-200 p-2">
              ...
              <div className="relative aspect-[4/5] rounded-xl overflow-hidden bg-black">
                ...
                >
                  <source src="https://firebasestorage.googleapis.com/v0/b/chumwallet.appspot.com/o/videoplayback.mp4?alt=media&token=ec363a65-a3cf-4343-a995-bb09cccda322" type="video/mp4" />
                  <img 
          ...
          >
            ...
            <div>
              <h2 
                ...
                data-aos-delay="300"
              >
                A <span className="text-[#F97316]">Visionary Leader</span> for Nigeria's Future
              </h2>
              <div 
            ...
            <div className="space-y-6">
              <p 
                ...
                data-aos-delay="500"
              >
                A visionary leader and innovative thinker dedicated to transforming Nigeria's future through strategic policy development, 
                technological advancement, and sustainable community development initiatives.
              </p>
              ...
              <p 
                ...
                data-aos-delay="600"
              >
                With over a decade of experience in public policy and social innovation, Seun has pioneered numerous initiatives 
            ...
            >
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600 text-sm">Pioneering digital transformation and policy innovation across Nigeria</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600 text-sm">Empowering communities through sustainable development initiatives</p>
                </div>
              </div>
