...
function Digital_Ekiti_Initiatives_Detail() {
  ...
  return (
    <section className="text-[#1D1D1D] text-sm">
      <div
        className="min-h-96 bg-center bg-cover flex flex-col justify-center text-white pl-5 lg:pl-10 relative"
      ...
      <div className="pl-5 lg:pl-10 pr-10 py-10">
        <div className="flex flex-col lg:flex-row gap-5 justify-between">
          ...
          <div>
            <div className="bg-[#F7F7F7] p-6 rounded-md">
              <h3 className="font-semibold text-base pb-5">
                Initiative Details
              </h3>
