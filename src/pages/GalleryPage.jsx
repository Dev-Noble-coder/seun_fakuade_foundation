...
function GalleryPage() {
  ...
  const galleryItems = [
    ...
    },
    {
      ...
      description: "Transforming local communities through sustainable development",
      date: "February 2024",
    ...
    },
    {
      ...
      category: "community",
      image: "https://res.cloudinary.com/drhfrgahv/image/upload/v1752913806/IMG-20250718-WA0103_es1daj.jpg",
  ...
  return (
    <div className="min-h-screen bg-white pt-20">
      ...
      <section className="bg-gradient-to-r from-gray-50 to-blue-50 py-20">
        <div className="max-w-7xl mx-auto px-5 lg:px-20 text-center">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
            Explore the moments, projects, and partnerships that define our journey in creating positive change.
          </p>
        </div>
      </section>
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-5 lg:px-20">
          <h2 className="text-3xl font-bold text-gray-900 text-center mb-12">Featured Highlights</h2>
                ...
                <div key={item.id} className="w-full flex-shrink-0">
                  <div className="grid grid-cols-1 lg:grid-cols-2 gap-0">
                    ...
                    <div className="p-8 lg:p-12 flex flex-col justify-center">
                      ...
                      <h3 className="text-3xl lg:text-4xl font-bold text-gray-900 mb-4">{item.title}</h3>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-5 lg:px-20">
          <h2 className="text-3xl font-bold text-gray-900 text-center mb-12">All Gallery Items</h2>
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-4xl mx-auto text-center px-5 lg:px-20" data-aos="fade-up">
